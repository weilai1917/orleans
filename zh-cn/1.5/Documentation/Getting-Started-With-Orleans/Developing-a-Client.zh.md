...
More information is in the [Client Configuration guide](../Deployment-and-Operations/Configuration-Guide/Client-Configuration.zh.md).
...
[Observers](../Core-Features/Observers.zh.md) is one such mechanism that enables exposing client side objects as grain-like targets to get invoked by grains.
...
Another mechanism that can be used for delivering asynchronous messages to clients is [Streams](../Orleans-Streams/index.zh.md). Streams expose indications of success or failure of delivery of individual messages, and hence enable reliable communication back to the client.
...
[Running the Application](Running-the-Application.zh.md)
